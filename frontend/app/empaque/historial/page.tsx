...
export default function HistorialEmpaquePage() {
  const [ordenes, setOrdenes] = useState<Orden[]>([]);
  const [cargando, setCargando] = useState(true);
  const [error, setError] = useState("");

  useEffect(() => {
    apiFetch<Orden[]>("/api/empaque/historial", { rol: "Empaque" })
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-1">Historial de Empaque</h1>
      <p className="text-gray-500 mb-6">Pedidos ya empacados</p>
