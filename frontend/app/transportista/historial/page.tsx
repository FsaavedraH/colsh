...
export default function HistorialTransportistaPage() {
  const [ordenes, setOrdenes] = useState<Orden[]>([]);
  const [cargando, setCargando] = useState(true);
  const [error, setError] = useState("");

  useEffect(() => {
    apiFetch<Orden[]>("/api/despacho/historial", { rol: "Transportista" })
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-1">Historial de Entregas</h1>
      <p className="text-gray-500 mb-6">Pedidos ya entregados</p>
